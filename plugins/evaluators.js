...
var ldc = ''
var EMOJI_DETECT = ''
if (Config.LANG == 'EN') ldc = '*🛑 Link Detected! 🛑*', EMOJI_DETECT = "*🛑 Emoji Detected! 🛑*"
if (Config.LANG == 'ML') ldc = '*🛑 ലിങ്ക് കണ്ടെത്തി! 🛑*', EMOJI_DETECT = "*🛑 ഇമോജി കണ്ടെത്തി! 🛑*"
if (Config.LANG == 'ID') ldc = '*🛑 tautan terdeteksi! 🛑*', EMOJI_DETECT = "*🛑 Emoji terdeteksi! 🛑*"
