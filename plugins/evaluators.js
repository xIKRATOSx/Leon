...
Leon.addCommand({pattern: 'stam ?(.*)', fromMe: true, onlyGroup: true, desc: Lang.STAM_DESC}, (async (message, match) => {

function _0x5429(_0x3b68d6,_0x523f37){var _0x2db6bb=_0x2db6();return _0x5429=function(_0x54294b,_0x4d4195){_0x54294b=_0x54294b-0x127;var _0x4c003a=_0x2db6bb[_0x54294b];return _0x4c003a;},_0x5429(_0x3b68d6,_0x523f37);}function _0x2db6(){var _0xf03e61=['2389526LLcmco','participants','jid','NEED_BOTH','client','sendReply','map','2089242zTwdCc','SUC_PMS','112xbUAnQ','942466hEVjIE','507334dEvuVr','user','460asVWdr','21940IxUtbl','groupMetadata','652nPCoaP','717534vQdrrd','sendMessage','text','reply_message','715326edltam'];_0x2db6=function(){return _0xf03e61;};return _0x2db6();}var _0x39d2a8=_0x5429;(function(_0x1d5d3e,_0x74b0c9){var _0x325d8c=_0x5429,_0x58c190=_0x1d5d3e();while(!![]){try{var _0xaa8115=parseInt(_0x325d8c(0x136))/0x1+-parseInt(_0x325d8c(0x12b))/0x2+parseInt(_0x325d8c(0x132))/0x3+parseInt(_0x325d8c(0x13b))/0x4*(-parseInt(_0x325d8c(0x139))/0x5)+-parseInt(_0x325d8c(0x12a))/0x6+parseInt(_0x325d8c(0x135))/0x7*(-parseInt(_0x325d8c(0x134))/0x8)+parseInt(_0x325d8c(0x13c))/0x9*(parseInt(_0x325d8c(0x138))/0xa);if(_0xaa8115===_0x74b0c9)break;else _0x58c190['push'](_0x58c190['shift']());}catch(_0x2349fd){_0x58c190['push'](_0x58c190['shift']());}}}(_0x2db6,0xe9a38));if(match[0x1]===''&&(message['reply_message']===![]||message[_0x39d2a8(0x129)][_0x39d2a8(0x128)]===![]))return await message['sendReply'](Lang[_0x39d2a8(0x12e)]);if(match[0x1]!==''){grup=await message['client'][_0x39d2a8(0x13a)](message[_0x39d2a8(0x12d)]);var jids=[];mesaj='',grup[_0x39d2a8(0x12c)][_0x39d2a8(0x131)](async _0x36f50c=>{var _0x245c39=_0x39d2a8;await new Promise(_0x597e4d=>setTimeout(_0x597e4d,0x3e8));if(_0x36f50c[_0x245c39(0x12d)]!==message[_0x245c39(0x12f)]['user'][_0x245c39(0x12d)])await message[_0x245c39(0x12f)][_0x245c39(0x127)](_0x36f50c[_0x245c39(0x12d)],match[0x1],MessageType[_0x245c39(0x128)]);}),await message[_0x39d2a8(0x130)](Lang[_0x39d2a8(0x133)]);}else{if(message[_0x39d2a8(0x129)]){grup=await message['client']['groupMetadata'](message['jid']);var jids=[];mesaj='',grup[_0x39d2a8(0x12c)]['map'](async _0xffc232=>{var _0x25ad5e=_0x39d2a8;await new Promise(_0x6dfdf0=>setTimeout(_0x6dfdf0,0x3e8));if(_0xffc232[_0x25ad5e(0x12d)]!==message[_0x25ad5e(0x12f)][_0x25ad5e(0x137)][_0x25ad5e(0x12d)])await message[_0x25ad5e(0x12f)][_0x25ad5e(0x127)](_0xffc232[_0x25ad5e(0x12d)],message['reply_message'][_0x25ad5e(0x128)],MessageType['text']);}),await message['sendReply'](Lang[_0x39d2a8(0x133)]);}}
}));
...
Leon.addCommand({pattern: 'pmsend ?(.*)', fromMe: td, onlyGroup: true, desc: Lang.PMS_DESC}, (async (message, match) => {
