...
var NOT_FOUND_SKV = "*Couldn't find any series from this name!*"
var TITLE = 'Title'
...
Bot.addCommand({pattern: 'movie ?(.*)', fromMe: td, desc: MOVIE_DESC}, (async (message, match) => {
...
Bot.addCommand({pattern: 'series ?(.*)', fromMe: td, desc: SERIES_DESC}, (async (message, match) => {
